            ...
            >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            <svg width="60" height="60">
                                ...
                                <circle cx="30" cy="30" r="20" fill="none" stroke="url(#gradient)" strokeWidth="4"
                ...
                <div className="mb-6">
                    <div className={`flex space-x-1 relative border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                        ...
                        <div className="absolute bottom-0 h-0.5 bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-300 ease-in-out"
                            style={{
                ...
                <div className="space-y-4">
                        ...
                        <>
                            <div className={`rounded-lg p-4 border ${isDarkMode ? 'bg-gray-800/50 border-gray-700' : 'bg-gray-50 border-gray-100'}`}>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className={`text-xs px-2 py-1 rounded-full ${isDarkMode ? 'text-green-400 bg-green-900/30' : 'text-green-600 bg-green-50'}`}>+12.5%</span>
                                </div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[{ label: 'Users', value: '1,428' }, { label: 'Sessions', value: '3,942' }, { label: 'Conversion', value: '4.2%' }].map((metric) => (
                                    <div key={metric.label} className={`rounded-lg p-3 border ${isDarkMode ? 'bg-gray-800/50 border-gray-700' : 'bg-gray-50 border-gray-100'}`}>
                    ...
                    {activeTab === 'analytics' && (
                        <div className="space-y-3">
                            {[
                                ...
                                <div key={item.label} className={`flex items-center justify-between py-3 ${index < 3 ? `border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-100'}` : ''}`}>
                    ...
                    {activeTab === 'reports' && (
                        <div className="space-y-3">
                            <div className={`rounded-lg p-4 border ${isDarkMode ? 'bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-gray-700' : 'bg-gradient-to-r from-blue-50 to-purple-50 border-gray-100'}`}>
